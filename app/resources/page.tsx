...
export default function ResourcesPage() {
  ...
  const faqs = [
      ...
      questions: [
        {
          ...
          answer: "PDF format only. The file should be a current in-force illustration from the carrier."
        },
        {
    ...
    },
    {
      ...
      questions: [
        {
          question: "How do I integrate this into my practice?",
        ...
        {
          question: "How do I explain this to clients?",
      ...
      questions: [
        {
          ...
          answer: <>Our support team is available at <a href="mailto:support@financialplanner-ai.com" className="text-[#4B6FEE] hover:underline">support@financialplanner-ai.com</a>. We typically respond within one business day.</>
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: <>To request a refund, email <a href="mailto:support@financialplanner-ai.com" className="text-[#4B6FEE] hover:underline">support@financialplanner-ai.com</a> and request a refund. You will receive a full refund within 14 days.</>
        }
      ]
    }
  ]
                ...
                <div className="p-8">
                  <div className="flex flex-col items-center text-center mb-6">
                    <div className="bg-[#4B6FEE]/10 p-4 rounded-full mb-4">
                      <resource.icon className="w-12 h-12 text-[#4B6FEE]" />
                    </div>
          ...
          {expandedSection && (
            ...
            >
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-semibold text-[#4B6FEE]">{expandedSection}</h3>
                <Button
                  variant="ghost"
                  size="icon"
