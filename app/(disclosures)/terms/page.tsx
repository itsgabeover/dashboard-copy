          ...
          <div className="prose prose-gray dark:prose-invert max-w-4xl mx-auto">
            ...
            <section className="mb-12">
              ...
              <p className="text-base mb-4">
                ...
                control with Financial Planner AI, where "control" means the ownership of, or the power to vote, at
                least fifty percent (50%) of the voting stock, shares or interests of such entity.
              </p>
              <p className="text-base mb-4">
                "AI Technology" means our artificial intelligence and machine learning technologies, algorithms, models,
                and systems used to provide the Services.
              </p>
              <p className="text-base mb-4">
                "Analyses" means the outputs, reports, summaries, and other materials generated by our AI Technology
                based on the information and documentation you provide.
              </p>
              <p className="text-base mb-4">
                "Confidential Information" means any non-public information that relates to our business, technology,
                customers, or Services, including but not limited to our AI Technology, trade secrets, know-how,
                software code, technical specifications, development plans, and business strategies.
              </p>
              <p className="text-base mb-4">
                "Content" means all information, data, text, documents, graphics, images, photographs, videos, software,
                music, sounds, and other materials that may be available through the Services.
              </p>
              <p className="text-base mb-4">
                "Documentation" means any user guides, help materials, or other documentation we provide or make
                available regarding the Services.
              </p>
              <p className="text-base mb-4">
                "Feedback" means any suggestions, ideas, enhancement requests, recommendations, or other feedback you
                provide regarding the Services.
              </p>
              <p className="text-base mb-4">
                ...
                rights, and other intellectual property rights that may exist now or come into existence in the future,
                under the laws of any state, country, territory or other jurisdiction.
              </p>
              <p className="text-base mb-4">
                "Policy Owner" means an individual who owns a life insurance policy and uses our Services to analyze
                such policy.
              </p>
              <p className="text-base mb-4">
                "Professional Advisor" means a licensed financial advisor, insurance agent, attorney, accountant, or
                other professional who may use our Services to assist Policy Owners.
              </p>
              <p className="text-base mb-4">
                "User Content" means any Content that you submit, upload, publish, or otherwise make available through
                the Services.
              </p>
            ...
            <section className="mb-12">
              ...
              <p className="text-base mb-4">
                ...
                ("Feedback"), you hereby grant Financial Planner AI a worldwide, perpetual, irrevocable, royalty-free
                license to use, incorporate, modify, display, perform, create derivative works from, and otherwise
                exploit such Feedback for any purpose without restriction or compensation to you.
              </p>
            </section>
            <section className="mb-12">
              ...
              <p className="text-base mb-4">
                ...
                resources ("Third-Party Services"). Your access and use of Third-Party Services is governed solely by
                the terms and conditions of such Third-Party Services. Financial Planner AI does not endorse, is not
                responsible for, and makes no representations or warranties regarding any Third-Party Services,
