    ...
    <div className="max-w-4xl mx-auto px-4 py-4">
      <div className="terms-of-use bg-white p-6 rounded-lg shadow-md mb-4">
        ...
        <p className="text-base text-gray-700 mb-4">
          ...
          by these Terms of Use ("Terms"). Please read them carefully.
        </p>
        ...
        <p className="text-base text-gray-700 mb-4">
          ...
          website. Continued use of the services following the changes indicates
        ...
        <p className="text-base text-gray-700 mb-4">
          ...
          complete information and to keep your account information updated.
        </p>
        ...
        <p className="text-base text-gray-700 mb-4">
          ...
          services in any way that may damage, disable, overburden, or impair
          the services.
        </p>
        ...
        <p className="text-base text-gray-700 mb-4">
          ...
          text, graphics, logos, and software) provided as part of the services
        ...
        <p className="text-base text-gray-700 mb-4">
          To the maximum extent permitted by law, [Your Company Name] shall not
        ...
        <p className="text-base text-gray-700 mb-4">
          For any questions about these Terms, please contact us at [Your
          Contact Information].
        </p>
      </div>
      ...
      <div className="prose max-w-none">
        ...
        >
          <a
            href="/disclosures/terms_of_use.txt"
            download="/disclosures/terms_of_use.txt"
          >
