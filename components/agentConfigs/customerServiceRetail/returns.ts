import { AgentConfig, TranscriptItem } from "@/types/realtime";
...
`,
  ...
  toolLogic: {
    ...
    retrievePolicy: (
      ...
      // Reference the parameters to mark them as used.
      void _args;
      void _transcriptLogsFiltered;
      return `
...
`;
    ...
    checkEligibilityAndPossiblyInitiateReturn: async (
      _args: unknown,
      _transcriptLogs: TranscriptItem[]
    ) => {
      // Reference unused parameters to avoid ESLint errors.
      void _args;
      void _transcriptLogs;

      console.log("checkEligibilityAndPossiblyInitiateReturn()", _args);
...
<conversationContext>
${JSON.stringify(_transcriptLogs.slice(nMostRecentLogs), null, 2)}
</conversationContext>
