  ...
  const reports = [
    {
      ...
      features: ['Comprehensive Policy Review', 'Risk Assessment', 'Action Items', 'Performance Metrics'],
    },
    {
      title: 'Life Insurance Policy Review Summary',
      image: '/placeholder.svg?height=200&width=300',
      features: ['Professional Formatting', 'Clear Explanations', 'Key Findings', 'Next Steps'],
    },
  ]
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {reports.map((report, index) => (
            <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden">
              <Image src={report.image} alt={report.title} width={300} height={200} className="w-full" />
              <div className="p-6">
